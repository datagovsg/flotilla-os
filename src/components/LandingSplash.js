...
const defaultText =
  "Flotilla is a self-service framework that dramatically simplifies the process of defining and executing containerized jobs for data science."
const textOptions = [
  {
    header: "You don't need data engineers 😉",
    text:
      "You need Flotilla, a self-service framework that dramatically simplifies the process of defining and executing containerized jobs for data science.",
  },
  {
